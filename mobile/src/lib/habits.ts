 ...
 * a workout or strength-training routine — there's no standalone dumbbell
 * object in Unicode, only person-lifting-weights pictographs, so this is the
 * closest fit that isn't a person.
 *
